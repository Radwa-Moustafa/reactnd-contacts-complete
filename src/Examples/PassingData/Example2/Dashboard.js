...
class MovieCardsList extends Component {
  render() {
    ...
    */
    const { profiles, users, movies, usersByMovie } = this.props; //instead of this.props.zeft masln

    const movieCards = Object.keys(movies).map(id => ( // Object.keys is used for key-value object of objects!!
      <MovieCard
        key={id}
        users={users}
